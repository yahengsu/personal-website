      ...
      <div className="main">
        ...
        <div className="desc">
          <p>
            ...
            Waterloo with a passion for technological innovation.
          </p>
          <p>
            Currently, I work on backend systems and digital identity protocols
            at{" "}
            <a
            ...
            . Previously, I worked on next-generation iOS banking solutions at
            the{" "}
            <a
          ...
          <p>
            I'm always looking for new opportunities to grow and meet new
            people. Connect with me on one of the platforms below, and let's
            chat!
          </p>
        </div>
        <a
